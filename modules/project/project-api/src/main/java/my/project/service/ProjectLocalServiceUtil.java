 ...
 * <code>my.project.service.impl.ProjectLocalServiceImpl</code> and
...
public class ProjectLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>my.project.service.impl.ProjectLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static Project addProject(
		...
		return getService().addProject(userId, groupId, name, serviceContext);
	}
	...
	public static Project renameProject(
		...
		return getService().renameProject(
	...
	public static Project updateProjectStatus(
		...
		return getService().updateProjectStatus(
